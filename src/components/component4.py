...
def affiche_nuages():
    ...
    if (
        "Total Affected" not in data.columns
        or "Total Damage Adjusted 000 US" not in data.columns
    ):
        print(
            "Les colonnes 'Total Affected' ou 'Total Damage Adjusted 000 US' sont manquantes."
        )
        return
